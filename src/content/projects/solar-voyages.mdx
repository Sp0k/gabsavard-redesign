...
In November 2023, my friends and I participated in the _NASA International Space App Challenges_,
...
Our goal was to build a full-stack website for this challenge. We had planned on using the _Razor
pages_ dotNet framework. We also wanted the website to look and feel realistic and professional.
...
<MobileGallery images={mobileImages()} client:load />
...
<a href="https://github.com/Sp0k/SpaceJam2023" target="_blank">repo</a> with the few files of
code we wrote.
