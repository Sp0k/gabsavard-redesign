...
export const cover = {
  src: "/pictures/projects/demo_ep/cover_1.png",
  alt: "A street at night with bright neon signs",
};

The _Demo EP_ is an EP I never released. It is composed of four songs I produced back in 2020 and
2021 in order to apply and be accepted in the _Digital Music Production Bachelor_ at the
...
_Running_ is the first song on the Demo EP. It is a mix between hip-hop and rock. This also was the
...
<AudioPlayer
  audioSrc="/music/demo_ep/Running.wav"
  songTitle="Running"
  artist="Tsuyosa"
  cover={cover}
  client:load
...
_Ballade_ is the second track on the EP. On this production, I decided to experiment with creating
...
to use a sample made by _Cymatics_ which I got from their free collection. I think the strength of
this production is its silences, they compliment the vibe I was going for.

<AudioPlayer
  audioSrc="/music/demo_ep/Ballade.wav"
  songTitle="Ballade"
  artist="Tsuyosa"
  cover={cover}
  client:load
...
_F E E L I N G S_ is the third song on the _Demo EP_. With this song, I again experimented with the
...
<AudioPlayer
  audioSrc="/music/demo_ep/F E E L I N G S.mp3"
  songTitle="F E E L I N G S"
  artist="Tsuyosa"
  cover={cover}
  client:load
/>
...
The last song on the EP is _Far West_. In this song, I was trying to experiment with effects on the
...
<AudioPlayer
  audioSrc="/music/demo_ep/Far West.wav"
  songTitle="Far West"
  artist="Tsuyosa"
  cover={cover}
  client:load
