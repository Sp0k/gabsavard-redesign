  ...
  return (
    <div>
      <div className="flex flex-col md:flex-row justify-between items-center mx-5 md:mx-6 lg:mx-8 xl:mx-10 mt-[14px] bg-[#252525]">
        ...
        <ul
          className={`${isOpen ? "h-0" : "h-[90%]"} rounded-3xl md:h-fit z-10 absolute md:relative md:right-0 flex flex-col md:flex-row overflow-hidden items-center list-none bg-[#252525] md:bg-transparent w-[95%] md:w-auto mt-12 md:mt-0 transition-all`}
        >
